package com.exerc.cio.springtdd.springTdd.model;
...
import com.exerc.cio.springtdd.springTdd.repository.ContatoRepository;
...
public class Contato {
	...
	@Before
	public void start() {
		contato = new ContatoModel("Carol", "011y", "9xxxxxxx9");
	}
